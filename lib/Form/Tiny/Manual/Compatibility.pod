...
Because of this, parameters they get passed tended to vary. For example the C<default> sub used to get passed a single parameter, which is a form instance, while form validator would not get passed a form instance, making it hard or impossible to make use of instance data in certain places.
